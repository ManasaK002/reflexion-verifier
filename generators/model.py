...
class GPT4(GPTChat):
    # Kept for reference / comparison — original paper's backbone.
    # Requires `pip install openai==0.27.0` and OPENAI_API_KEY set. Not
    # needed for the Gemini-based path this project uses by default.
    def __init__(self):
